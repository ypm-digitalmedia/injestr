...
-->
		...
		<footer>
			<hr />
			<p align="center"><a href="javascript:feedbackEmail()">Report an issue</a> | <i class="fas fa-code-branch"></i> <strong id="appVersion">0.2.18</strong> | <i class="fas fa-calendar-alt"></i> Dec 4 2018</p>
		</footer>
