...
-->
		...
		<footer>
			<hr />
			<p align="center"><a href="javascript:feedbackEmail()">Report an issue</a> | <i class="fas fa-code-branch"></i> <strong id="appVersion">0.3.2</strong> | <i class="fas fa-calendar-alt"></i> Dec 14 2018</p>
		</footer>
