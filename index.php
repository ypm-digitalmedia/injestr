...
-->
		...
		<footer>
			<hr />
			<p align="center"><a href="javascript:feedbackEmail()">Report an issue</a> | <i class="fas fa-code-branch"></i> <strong id="appVersion">0.5.6</strong> | <i class="fas fa-calendar-alt"></i> 13 Jul 2023</p>
		</footer>
